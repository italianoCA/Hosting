...
if env_loaded:
    ...
    print(f"Note: No .env file found at: {os.path.abspath(env_path)} — using environment variables")
...
mcp.settings.port = int(os.environ.get("PORT", 8086))
mcp.settings.transport_security.enable_dns_rebinding_protection = False

# --- Configuration ---
SNOW_BASE_URL = os.environ.get("SNOW_BASE_URL", "https://ven05620.service-now.com").rstrip("/")
SNOW_CREDENTIAL = os.environ.get("SNOW_CREDENTIAL", "")
VA_SYS_ID = os.environ.get("SNOW_VA_SYS_ID", "")
